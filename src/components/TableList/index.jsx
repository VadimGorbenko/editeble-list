      ...
      <table className="list-block__table" aria-label="Редактируемая таблица с ФИО">
        <tbody>
          ...
          <tr className="list-block__table-row">
            ...
            <td className="list-block__table-cell">
              <span className='list-block__table-cell-text'>Горбенко</span>
              <input type="text" className='list-block__table-cell-input visibility-hidden' value="Горбенко" placeholder="Горбенко"/>
            </td>
            <td className="list-block__table-cell">
              <span className='list-block__table-cell-text'>Вадим</span>
              <input type="text" className='list-block__table-cell-input visibility-hidden' value="Вадим" placeholder="Вадим"/>
            </td>
            <td className="list-block__table-cell">
              <span className='list-block__table-cell-text'>Вадимович</span>
              <input type="text" className='list-block__table-cell-input visibility-hidden' value="Вадимович" placeholder="Вадимович"/>
            </td>
            <td className="list-block__table-cell">
